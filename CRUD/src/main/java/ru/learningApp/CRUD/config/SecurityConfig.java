package ru.learningApp.CRUD.config;

import ru.learningApp.CRUD.dao.abstr.UserRepository;
import ru.learningApp.CRUD.security.jwt.JwtRequestFilter;
...
import static ru.learningApp.CRUD.security.SecurityConstants.SIGN_UP_URL;
...
//                .permitAll();
        ...
        http
                ...
                .authorizeRequests()
                //страницы аутентикаци доступна всем
                .antMatchers("/login",
                        "/authenticate",
                        "/rest/registerUser",
                        "/error",
                        SIGN_UP_URL).anonymous()
                .antMatchers("/js/**", "/css/**", "/webjars/**", "/authenticate").permitAll()
                // защищенные URL
